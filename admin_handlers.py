...
from utils import get_game_data, send_game_status_update#, is_private_chat
...
async def add_game_venue(update: Update, context: ContextTypes.DEFAULT_TYPE):
    logging.info(f"Called {add_game_venue.__name__} with context: {context}")
...
async def add_game_capacity(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if update.message:
        ...
        await update.callback_query.edit_message_text("Capacity must be a number. Please enter the capacity:")
        return ADD_GAME_CAPACITY
...
async def edit_existing_game(update: Update, context: ContextTypes.DEFAULT_TYPE):
    logging.info(f"Called {edit_existing_game.__name__} with context: {context}")
...
async def handle_edit_game_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    logging.info(f"Called {handle_edit_game_callback.__name__} with context: {context}")
...
async def handle_edit_attribute_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    logging.info(f"Called {handle_edit_attribute_callback.__name__} with context: {context}")
...
async def handle_new_attribute_value(update: Update, context: ContextTypes.DEFAULT_TYPE):
    logging.info(f"Called {handle_new_attribute_value.__name__} with context: {context}")
...
async def edit_game_finish(update: Update, context: ContextTypes.DEFAULT_TYPE):
    logging.info(f"Called {edit_game_finish.__name__} with context: {context}")
...
async def manage_games_menu(update: Update, context: ContextTypes.DEFAULT_TYPE):
    logging.info(f"Called {manage_games_menu.__name__} with context: {context}")
...
async def show_game_details(update: Update, context: ContextTypes.DEFAULT_TYPE):
    logging.info(f"Called {show_game_details.__name__} with context: {context}")
    ...
    keyboard = [
        [InlineKeyboardButton("Edit Game", callback_data = f"edit_game_{game_id}")],
        [InlineKeyboardButton("Cancel Game", callback_data=f"cancel_game_{game_id}")],
        [InlineKeyboardButton("Announce Game", callback_data=f"announce_game_{game_id}")],
        [InlineKeyboardButton("Register Player", callback_data=f"register_player_for _game_{game_id}")],
        [InlineKeyboardButton("Unregister Player", callback_data=f"unregister_player_from_game_{game_id}")],
...
async def start_register_player(update: Update, context: ContextTypes.DEFAULT_TYPE):
    logging.info(f"Called {start_register_player.__name__} with context: {context}")
...
async def handle_register_player(update: Update, context: ContextTypes.DEFAULT_TYPE):
    logging.info(f"Called {handle_register_player.__name__} with context: {context}")
...
async def start_remove_player(update: Update, context: ContextTypes.DEFAULT_TYPE):
    logging.info(f"Called {start_remove_player.__name__} with context: {context}")
...
async def start_remove_player_from_game(update: Update, context: ContextTypes.DEFAULT_TYPE):
    logging.info(f"Called {start_remove_player_from_game.__name__} with context: {context}")
...
async def handle_remove_player(update: Update, context: ContextTypes.DEFAULT_TYPE):
    logging.info(f"Called {handle_remove_player.__name__} with context: {context}")
