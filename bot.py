...
#    entry_points=[
#        CallbackQueryHandler(manage_games_menu, pattern='^manage_games$')
#        ],
#    states={
#        States.SELECT_GAME: [
...
#    application.add_handler(CallbackQueryHandler(unhandled_callback_query), group=99)
    ...
    application.add_handler(CallbackQueryHandler(manage_games_menu, pattern='^manage_games$'), group=0)
